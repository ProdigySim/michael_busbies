...
// css
import '../css/resume.module.scss';

// imgs
import bvLogoUrl from '../images/resume/bv-logo.jpg';
import curalateLogoUrl from '../images/resume/curalate-logo.png';
import bevyupLogoUrl from '../images/resume/bevyup-logo.png';
...
export default function Resume() {
  return (
    <main className="resume">
      ...
      <div style={{float: 'left', width: '100px', height: '100px' }}><Image className="logo" src={curalateLogoUrl} alt="Curalate Logo" /></div>
